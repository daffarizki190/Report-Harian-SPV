...
<body class="bg-slate-900 h-screen w-screen flex items-center justify-start p-12 relative overflow-hidden font-outfit">
    <!-- Parking Background -->
    <div class="fixed inset-0 z-0">
        <img src="{{ asset('img/login-bg.png') }}" class="w-full h-full object-cover opacity-70" alt="Background">
        <div class="absolute inset-0 bg-gradient-to-r from-slate-950/80 via-slate-950/20 to-transparent"></div>
    </div>

    <div class="relative z-10 w-full max-w-sm ml-10">
        <div class="bg-slate-900/40 backdrop-blur-2xl border border-white/10 p-7 rounded-[32px] shadow-2xl animate-fade-in relative overflow-hidden w-full">
            <!-- Decorative Glow -->
